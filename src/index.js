...
setInterval(() => {
  ...
  data = {
    counters: {
      "node.eventloop.latency.0.milliseconds": latencies['0'] || 0,
      "node.eventloop.latency.1.milliseconds": latencies['1'] || 0,
      "node.eventloop.latency.2.milliseconds": latencies['2'] || 0,
      "node.eventloop.latency.5.milliseconds": latencies['5'] || 0,
      "node.eventloop.latency.10.milliseconds": latencies['10'] || 0,
      "node.eventloop.latency.20.milliseconds": latencies['20'] || 0,
      "node.eventloop.latency.50.milliseconds": latencies['50'] || 0,
      "node.eventloop.latency.100.milliseconds": latencies['100'] || 0,
      "node.eventloop.latency.200.milliseconds": latencies['200'] || 0,
      "node.eventloop.latency.400.milliseconds": latencies['400'] || 0,
      "node.eventloop.latency.1000.milliseconds": latencies['1000'] || 0,
      "node.eventloop.latency.2000.milliseconds": latencies['2000'] || 0,
      "node.eventloop.latency.2000+.milliseconds": latencies['2000+'] || 0,
